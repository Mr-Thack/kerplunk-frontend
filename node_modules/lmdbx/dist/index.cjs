					...
					next() {
						...
						if (includeValues) {
							...
							if (store.decoder) {
								...
								value = Uint8ArraySlice$1.call(bytes, 0, lastSize);
							else {
...
function open(path$1, options) {
   ...
   if (rc)
	...
	addReadMethods(LMDBXStore, { env, maxKeySize, keyBytes, keyBytesView, getLastVersion: getLastVersion$1 });
	if (!options.readOnly)
...
orderedBinary$1.enableNullTermination();
...
setNativeFunctions(require$2('node-gyp-build')(dirName));
setExternals({
	require: require$2, arch: os.arch, fs: fs$1, path: path$1__default, MsgpackrEncoder: msgpackr.Encoder, WeakLRUCache: weakLruCache.WeakLRUCache, orderedBinary: orderedBinary$1, EventEmitter: EventEmitter$1
});
var nodeIndex = {
	open, getLastVersion: getLastVersion$1, compareKey: orderedBinary$1.compareKeys, keyValueToBuffer: orderedBinary$1.toBufferKey, bufferToKeyValue: orderedBinary$1.fromBufferKey, path: path$1__default, EventEmitter: EventEmitter$1
};

Object.defineProperty(exports, 'bufferToKeyValue', {
    enumerable: true,
    get: function () {
        return orderedBinary$1.fromBufferKey;
    }
});
Object.defineProperty(exports, 'compareKey', {
    enumerable: true,
    get: function () {
        return orderedBinary$1.compareKeys;
    }
});
...
Object.defineProperty(exports, 'keyValueToBuffer', {
    enumerable: true,
    get: function () {
        return orderedBinary$1.toBufferKey;
    }
});
exports.ABORT = ABORT;
