...
However, there are a few reasons for remaining with the core LMDB/lmdb-js package/project:
...
* lmdb-js supports encryption and larger database size (libmdbx is limited to 2^31 x pagesize, or usually 8TB).
